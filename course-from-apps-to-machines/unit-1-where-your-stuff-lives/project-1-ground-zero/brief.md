...
| Windows + WSL | "You must be running Windows 10 version 2004 and higher (Build 19041 and higher) or Windows 11"; install with `wsl --install`, which gives Ubuntu by default. |
