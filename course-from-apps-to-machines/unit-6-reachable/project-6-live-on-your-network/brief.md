...
**Your machine — WSL.** `wsl --install` installs Ubuntu by default and sets WSL 2 by default; you
need "Windows 10 version 2004 and higher (Build 19041 and higher) or Windows 11". The default WSL
Ubuntu image ships `python3 3.12.3-0ubuntu2`, `curl 8.5.0-2ubuntu10.6`, and `iproute2
