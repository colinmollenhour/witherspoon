...
**Front:** `ping -c 3 example.com` — what is `-c 3` for, and what does the last part of the output tell you?
...
**Front:** Your `curl` failed. You did not read the message. What single observation tells you whether the port was closed or the host was unreachable?
...
**Front:** You want the operating system's actual reason for a refused connection, not curl's summary. What do you add?
