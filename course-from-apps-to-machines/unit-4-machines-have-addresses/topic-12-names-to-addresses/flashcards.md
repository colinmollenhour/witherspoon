...
**Front:** You want the IP address a hostname resolves to, printed on its own with no report around it. What do you run?
...
**Front:** `hosts: files mdns4_minimal [NOTFOUND=return] dns myhostname` — what is this line saying, and where does it live?
